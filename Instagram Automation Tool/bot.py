...
class InstaAutoBot:
    ...
    def login(self, username, password):
        self.driver = webdriver.Chrome(executable_path="C:\\Users\\LENOVO\\Desktop\\instabot\\webdrivers\\chromedriver.exe")
    ...
    # Function to Like and Comment on Posts of Particular username.
    # Also provide Number of Posts to be liked and commented on it
    ...
    # Function to follow the Users based on usernames
